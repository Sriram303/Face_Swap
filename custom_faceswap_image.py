...
frontal_face_predictor = dlib.shape_predictor("C:/Users/vasukisriram/Downloads/tools/code/dataset/shape_predictor_68_face_landmarks.dat")

#read the source face image and convert it to grayscale
source_image = cv2.imread("C:/Users/vasukisriram/Downloads/tools/code/images/jason.jpg")
source_imag_copy = source_image
...
destination_image = cv2.imread("C:/Users/vasukisriram/Downloads/tools/code/images/brucewills.jpg")
dest_image_copy = destination_image 
